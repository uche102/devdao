...
def test_football_bets_success_win():
    ...
    assert get_bet_result == {
        get_default_account().address: football_bets_win_unresolved
    }
    ...
    get_bet_result = contract.get_bets(args=[])
    assert get_bet_result == {get_default_account().address: football_bets_win_resolved}

    get_points_result = contract.get_points(args=[])
    assert get_points_result == {get_default_account().address: 1}
...
def test_football_bets_draw_success():
    ...
    get_bet_result = contract.get_bets(args=[])
    assert get_bet_result == {
        get_default_account().address: football_bets_draw_unresolved
    }
    ...
    get_bet_result = contract.get_bets(args=[])
    assert get_bet_result == {get_default_account().address: football_bets_draw_resolved}
...
def test_football_bets_unsuccess():
    ...
    get_bet_result = contract.get_bets(args=[])
    assert get_bet_result == {
        get_default_account().address: football_bets_unsuccess_unresolved
    }
    ...
    get_bet_result = contract.get_bets(args=[])
    assert get_bet_result == {
        get_default_account().address: football_bets_unsuccess_resolved
    }
